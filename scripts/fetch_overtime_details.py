...
def find_best_stub(node, keywords=("durée du travail", "heures supplémentaires", "contingent", "majoration")):
...
def main():
    ...
    print(f"\nTerminé: {n_updated} CCN complétées, {n_skipped} sans clause heures sup trouvée, {n_error} erreurs.")
