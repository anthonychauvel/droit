...
def find_best_stub(node, keywords=("classification", "coefficient", "niveau hiérarchique", "grille de classification")):
...
def main():
    ...
    print(f"\nTerminé: {n_updated} CCN complétées, {n_skipped} sans section classification trouvée, {n_error} erreurs.")
