...
MOTS_CLES = {
    # Code pénal
    '222-33': ['harcèlement sexuel', 'propos à connotation sexuelle', 'pression grave pour acte sexuel'],
    ...
    '222-33-2-2': ['cyberharcèlement', 'harcèlement en ligne', 'harcèlement via les réseaux sociaux'],
    '225-1': ['discrimination', 'critères de discrimination', 'critères prohibés de discrimination'],
    '225-2': ['discrimination à l\'embauche', 'refus d\'embauche discriminatoire', 'licenciement discriminatoire', 'discrimination syndicale'],
    '225-3': ['exception discrimination justifiée', 'discrimination positive légale'],
    ...
    '223-1': ['mise en danger d\'autrui', 'risque causé à autrui', 'obligation de sécurité de résultat'],
    '225-4-1': ['traite des êtres humains'],
    '225-4-2': ['traite des êtres humains aggravée'],
    '225-4-13': ['travail forcé', 'exploitation par le travail', 'esclavage moderne', 'réduction en servitude'],
    '225-14': ['conditions de travail contraires à la dignité', 'hébergement indigne', 'conditions de logement indignes travailleurs'],
    '225-14-1': ['abus de vulnérabilité au travail'],
    '225-14-2': ['soumission à des conditions de travail indignes'],
    '226-1': ['atteinte à la vie privée', 'enregistrement à l\'insu', 'enregistrement clandestin au travail', 'surveillance illégale du salarié'],
    ...
    '431-1': ['délit d\'entrave', 'entrave à la liberté de réunion', 'entrave au droit de grève'],
    ...
    '1112': ['négociation précontractuelle', 'rupture des négociations', 'rupture abusive des négociations'],
    '1112-1': ['devoir d\'information précontractuelle'],
    '1193': ['modification du contrat', 'révocation du contrat'],
    '1217': ['inexécution du contrat', 'sanctions de l\'inexécution', 'inexécution des obligations contractuelles'],
    '1218': ['force majeure', 'événement imprévisible contrat'],
    '1221': ['exécution forcée en nature'],
    '1223': ['réduction du prix'],
    '1231-1': ['dommages-intérêts', 'réparation du préjudice contractuel', 'dommages et intérêts pour inexécution'],
